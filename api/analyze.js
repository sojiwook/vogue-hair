...
[${ci.label}] 부위 두피 이미지를 보고 아래 3문장을 순서대로 작성해주세요.

1문장 — 이미지에서 관찰되는 두피 상태 + 가장 두드러진 특징 (예: "모공이 넓고 수분이 낮은 건성 패턴이 관찰됩니다.")
2문장 — 이 상태의 의미 또는 원인 (예: "두피 장벽이 약해 수분 손실이 빠른 상태예요.")
3문장 — 내일 당장 실천 가능한 행동, "~하시면 됩니다" 톤 (예: "샴푸 후 두피 전용 세럼을 1~2방울 적용하시면 됩니다.")

주의:
- 이미지에서 보이는 것만 서술. 추측·부연 설명 금지.
- 응답 시작에 "[${ci.label}]" 같은 부위 레이블 절대 쓰지 말 것
- 3문장만 출력 (번호 없이, 각 문장 1줄)
- "위험", "악화", "심각" 표현 금지
- 한국어로 작성
